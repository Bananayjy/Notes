...
C:\Users\23220\\.VirtualBox文件也要相对应的修改，通过上面移动操作，会帮我们自动映射好

![image-20250409144643269](%E8%99%9A%E6%8B%9F%E6%9C%BA%E5%AE%89%E8%A3%85.assets/image-20250409144643269.png)

同时要确保.vagrant\machines\default\virtualbox\id的id要和vbox 的id保持一致
...
![img](%E8%99%9A%E6%8B%9F%E6%9C%BA%E5%AE%89%E8%A3%85.assets/6ceb364b68f34950b4b4f5169a1555e1tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)



通过vagrant完成虚拟机的迁移：

![image-20250409151818837](%E8%99%9A%E6%8B%9F%E6%9C%BA%E5%AE%89%E8%A3%85.assets/image-20250409151818837.png)

关于vagrant中的内容迁移可以看这个文章

> https://blog.csdn.net/glatchen/article/details/83187484
>
> https://juejin.cn/post/6844904190687313934
...
- ：wq 保存即可
- service sshd restart：保存配置

修改账号密码：

- passwd root

> 相关账号密码配置：http://wxnacy.com/2019/07/18/vagrant-root-login/
...
连接到服务器上，通过`lsblk`可以看到对应的磁盘大小已经是100GB了，但是其对应的分区还是40G：

![image-20250409134856503](%E8%99%9A%E6%8B%9F%E6%9C%BA%E5%AE%89%E8%A3%85.assets/image-20250409134856503.png)

这里的sda1表示第一块磁盘sda的第一分区，同理sda2表示第二块分区.

对应挂载的文件系统（即根目录/）也还是40G

![image-20250409135037274](%E8%99%9A%E6%8B%9F%E6%9C%BA%E5%AE%89%E8%A3%85.assets/image-20250409135037274.png)

首先要对sda磁盘进行分区，将多的60GB都分给sda1:

```
fdisk /dev/sda
d // 先删掉1号分区sda1，在新增1号分区，就想到于对1号分区进行修改了
n
p
1
两次回车默认剩余全部空间
...
然后通过`partprobe`命令对分区进行刷新（https://blog.csdn.net/ichen820/article/details/144560842）

![image-20250409141316946](%E8%99%9A%E6%8B%9F%E6%9C%BA%E5%AE%89%E8%A3%85.assets/image-20250409141316946.png)

可以看到其挂载的/还是40GB

![image-20250409141427499](%E8%99%9A%E6%8B%9F%E6%9C%BA%E5%AE%89%E8%A3%85.assets/image-20250409141427499.png)
...
![image-20250409141549774](%E8%99%9A%E6%8B%9F%E6%9C%BA%E5%AE%89%E8%A3%85.assets/image-20250409141549774.png)

如果是 **ext4/ext3/ext2** 文件系统：
...
Vagrant.configure("2") do |config|
  ...
  # 使用用户名+密码登录（默认使用private_key登录）
  #config.ssh.username = "banana"
	#config.ssh.password = "banana"
  ...
  # 共享文件设置
  config.vm.synced_folder "Y:/Banana/VirtulBox/shareData", "/home/vagrant/data"
